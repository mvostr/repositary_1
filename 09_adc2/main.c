...
//    uint16_t VAL1 = 0xFFF;
//    uint16_t VAL2 = 0xFFF;
 //   TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL1, VAL1*rawResult/4096);
 //   TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL2, VAL2*rawResult/4096);
...
int main()
{
  ...
  while (1)
  {
    ...
    {
      // включить светодиоды
        TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL1, 0xFFF*rawResult/4096);
        TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL2, 0xFFF*rawResult/4096);
    ...
    else
    {
      // выключить светодиоды
        TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL1, 0x000);
        TIMER_SetChnCompare(MDR_TIMER1, TIMER_CHANNEL2, 0x000);
        //если нажат RIGHT
